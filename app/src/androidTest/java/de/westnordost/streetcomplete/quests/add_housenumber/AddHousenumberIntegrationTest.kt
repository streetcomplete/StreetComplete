...
class AddHousenumberIntegrationTest : TestCase() {

    fun test_unspecified_building_type_is_excluded() {
    ...
    fun test_underground_building_is_excluded() {
        verifyYieldsNoQuest(
    ...
    fun test_building_type_that_likely_has_no_address_is_excluded() {
        verifyYieldsNoQuest(
    ...
    fun test_building_with_address_is_excluded() {
        verifyYieldsNoQuest(
    ...
    fun test_relation_building_with_address_is_excluded() {
        verifyYieldsNoQuest(
    ...
    fun test_building_with_address_inside_is_excluded() {
        verifyYieldsNoQuest(
    ...
    fun test_building_with_address_inside_but_outside_boundingBox_is_excluded_nevertheless() {
        verifyYieldsNoQuest(
    ...
    fun test_relation_building_with_address_inside_is_excluded() {
        verifyYieldsNoQuest(
    ...
    fun test_relation_building_with_address_inside_but_outside_boundingBox_is_excluded() {
        verifyYieldsNoQuest(
    ...
    fun test_building_with_address_on_outline_is_excluded() {
        verifyYieldsNoQuest(
    ...
    fun test_building_with_address_on_outline_but_outside_boundingBox_is_excluded_nevertheless() {
        verifyYieldsNoQuest(
    ...
    fun test_relation_building_with_address_on_outline_is_excluded() {
        verifyYieldsNoQuest(
    ...
    fun test_relation_building_with_address_on_outline_but_outside_boundingBox_is_excluded() {
        verifyYieldsNoQuest(
    ...
    fun test_building_within_area_with_address_is_excluded() {
        verifyYieldsNoQuest(
    ...
    fun test_building_within_relation_area_with_address_is_excluded() {
        verifyYieldsNoQuest(
