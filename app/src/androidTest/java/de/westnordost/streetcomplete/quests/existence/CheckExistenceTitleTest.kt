...
class CheckExistenceTitleTest {
    ...
    @Test fun issue2512() {
        val newspaperVendingMachineWithName = getQuestTitle(
            mapOf(
        ...
        val newspaperVendingMachineWithBrand = getQuestTitle(
            mapOf(
                "amenity" to "vending_machine",
                "vending" to "newspapers",
    ...
    @Test fun issue2806() {
        ...
        val unnamedBench = getQuestTitle(
            mapOf(
                "amenity" to "bench",
            )
        )
