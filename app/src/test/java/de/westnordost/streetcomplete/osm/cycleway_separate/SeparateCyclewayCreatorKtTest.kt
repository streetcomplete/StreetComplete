...
class SeparateCyclewayCreatorKtTest {
    ...
    @Test
    fun `apply none does not change bicycle=dismount`() {
        assertEquals(
    ...
    @Test
    fun `apply none re-tags cycleway and adds foot=yes if foot was no before`() {
        assertEquals(
            setOf(
    ...
    @Test
    fun `apply none re-tags cycleway to footway if foot is designated`() {
        assertEquals(
            setOf(
                StringMapEntryAdd("bicycle", "no"),
    ...
    @Test
    fun `apply none removes sidewalk and segregated tags`() {
        assertEquals(
            setOf(
                StringMapEntryAdd("bicycle", "no"),
    ...
    @Test
    fun `apply allowed does not re-tag bicycle=permissive etc`() {
        assertEquals(
            setOf(
                StringMapEntryModify("highway", "footway", "footway"),
    ...
    @Test
    fun `apply allowed re-tags cycleway and adds foot=yes if foot was not yes before`() {
        assertEquals(
            setOf(
                StringMapEntryAdd("bicycle", "yes"),
                StringMapEntryModify("highway", "cycleway", "footway"),
    ...
    @Test
    fun `apply allowed re-tags cycleway to footway if foot is designated`() {
        assertEquals(
            setOf(
                StringMapEntryAdd("bicycle", "yes"),
                StringMapEntryModify("highway", "cycleway", "footway"),
    ...
    @Test
    fun `apply allowed removes sidewalk and segregated tags`() {
        assertEquals(
            setOf(
                StringMapEntryModify("highway", "footway", "footway"),
                StringMapEntryAdd("bicycle", "yes"),
    ...
    @Test
    fun `apply non-designated does not change bicycle tag unless it is designated`() {
        assertEquals(
            setOf(
    ...
    @Test
    fun `apply non-designated re-tags cycleway and adds foot=yes if foot was not yes before`() {
        assertEquals(
            setOf(
                StringMapEntryModify("highway", "cycleway", "footway"),
                StringMapEntryModify("foot", "no", "designated")
    ...
    @Test
    fun `apply non-designated re-tags cycleway to footway if foot is designated`() {
        assertEquals(
            setOf(
                StringMapEntryModify("highway", "cycleway", "footway"),
                StringMapEntryModify("foot", "designated", "designated"),
    ...
    @Test
    fun `apply non-designated removes sidewalk and segregated tags`() {
        assertEquals(
            setOf(
                StringMapEntryModify("highway", "footway", "footway"),
                StringMapEntryDelete("segregated", "yes"),
    ...
    @Test
    fun `apply non-segregated does not re-tag any yes-like value`() {
        assertEquals(
    ...
    @Test
    fun `apply non-segregated removes sidewalk tags`() {
        assertEquals(
            setOf(
                StringMapEntryAdd("bicycle", "designated"),
                StringMapEntryAdd("segregated", "no"),
    ...
    @Test
    fun `apply segregated removes sidewalk tags`() {
        assertEquals(
            setOf(
                StringMapEntryAdd("bicycle", "designated"),
                StringMapEntryAdd("segregated", "yes"),
    ...
    @Test
    fun `apply exclusive removes sidewalk and segregated tags`() {
        assertEquals(
            setOf(
                StringMapEntryAdd("foot", "no"),
                StringMapEntryModify("highway", "cycleway", "cycleway"),
    ...
    @Test
    fun `apply exclusive with sidewalk`() {
        assertEquals(
            setOf(
    ...
    @Test
    fun `apply exclusive with sidewalk does not touch sidewalk tags if a sidewalk is already tagged`() {
        assertEquals(
            setOf(
                StringMapEntryModify("highway", "cycleway", "cycleway"),
                StringMapEntryAdd("check_date:bicycle", nowAsCheckDateString())
    ...
    @Test
    fun `apply exclusive with sidewalk removes segregated tags`() {
        assertEquals(
            setOf(
                StringMapEntryModify("highway", "cycleway", "cycleway"),
                StringMapEntryDelete("segregated", "yes"),
    ...
    @Test
    fun `apply path changes highway tag`() {
        assertEquals(
            setOf(StringMapEntryModify("highway", "cycleway", "path"),),
    ...
    @Test
    fun `apply path sets foot and bicycle if set`() {
        assertEquals(
            setOf(
                StringMapEntryModify("highway", "cycleway", "path"),
    ...
    @Test
    fun `apply path sets foot and bicycle only if not a value like permissive, private etc is set`() {
        assertEquals(
            setOf(StringMapEntryModify("highway", "cycleway", "path")),
            PATH.appliedTo(
                mapOf(
    ...
    @Test
    fun `apply path removes segregated and sidewalk`() {
        assertEquals(
            setOf(
                StringMapEntryModify("highway", "cycleway", "path"),
                StringMapEntryDelete("sidewalk", "both"),
    ...
    @Test
    fun `apply allowed on footway changes highway to footway if it isnt already`() {
        assertEquals(
            setOf(
                StringMapEntryAdd("bicycle", "yes"),
                StringMapEntryModify("highway", "cycleway", "footway")
    ...
    @Test
    fun `apply path removes bicycle_signed tag`() {
        assertEquals(
            setOf(
