...
class SeparateCyclewayParserKtTest {
    ...
    @Test fun `parse bicyclists allowed on path`() {
        ...
        assertEquals(ALLOWED, parse("highway" to "bridleway", "bicycle" to "yes"))
    ...
    @Test fun `parse cyclists on non-segregated path`() {
        ...
        assertEquals(NON_SEGREGATED, parse("highway" to "bridleway", "bicycle" to "designated", "segregated" to "no"))
    ...
    @Test fun `parse cyclists on segregated path`() {
        ...
        assertEquals(SEGREGATED, parse("highway" to "bridleway", "bicycle" to "designated", "segregated" to "yes"))
    ...
    @Test fun `parse cyclists on exclusive path`() {
        assertEquals(EXCLUSIVE, parse("highway" to "path", "bicycle" to "designated", "foot" to "no", "horse" to "no"))
        assertEquals(EXCLUSIVE, parse("highway" to "footway", "bicycle" to "designated", "foot" to "no"))
        assertEquals(EXCLUSIVE, parse("highway" to "bridleway", "bicycle" to "designated", "horse" to "no"))
    ...
    @Test fun `parse cycleway with sidewalk`() {
        ...
        assertEquals(EXCLUSIVE_WITH_SIDEWALK, parse("highway" to "bridleway", "bicycle" to "designated", "sidewalk" to "both"))
