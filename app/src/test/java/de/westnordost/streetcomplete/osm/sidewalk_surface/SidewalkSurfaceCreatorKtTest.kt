...
internal class SidewalkSurfaceCreatorKtTest {
    ...
    @Test fun `apply asphalt surface on both sides`() {
        verifyAnswer(
            mapOf(),
            LeftAndRightParsedSidewalkSurface(ParsedSurfaceAndNote(Surface.ASPHALT), ParsedSurfaceAndNote(Surface.ASPHALT)),
            arrayOf(
    ...
    @Test fun `apply different surface on each side`() {
        verifyAnswer(
            mapOf(),
            LeftAndRightParsedSidewalkSurface(ParsedSurfaceAndNote(Surface.ASPHALT), ParsedSurfaceAndNote(Surface.PAVING_STONES)),
            arrayOf(
    ...
    @Test fun `apply generic surface on both sides`() {
        verifyAnswer(
            ...
            LeftAndRightParsedSidewalkSurface(
                ParsedSurfaceAndNote(Surface.PAVED_ROAD, "note"),
                ParsedSurfaceAndNote(Surface.PAVED_ROAD, "note")
            ),
            arrayOf(
    ...
    @Test fun `sidewalk surface changes to be the same on both sides`() {
        verifyAnswer(
            ...
            LeftAndRightParsedSidewalkSurface(ParsedSurfaceAndNote(Surface.CONCRETE), ParsedSurfaceAndNote(Surface.CONCRETE)),
            arrayOf(
    ...
    @Test fun `sidewalk surface changes on each side`() {
        verifyAnswer(
            mapOf("sidewalk:left:surface" to "asphalt", "sidewalk:right:surface" to "paving_stones"),
            LeftAndRightParsedSidewalkSurface(ParsedSurfaceAndNote(Surface.CONCRETE), ParsedSurfaceAndNote(Surface.GRAVEL)),
            arrayOf(
    ...
    @Test fun `smoothness tag removed when surface changes, same on both sides`() {
        verifyAnswer(
            ...
            LeftAndRightParsedSidewalkSurface(ParsedSurfaceAndNote(Surface.PAVING_STONES), ParsedSurfaceAndNote(Surface.PAVING_STONES)),
            arrayOf(
...
private fun verifyAnswer(tags: Map<String, String>, answer: LeftAndRightParsedSidewalkSurface, expectedChanges: Array<StringMapEntryChange>) {
