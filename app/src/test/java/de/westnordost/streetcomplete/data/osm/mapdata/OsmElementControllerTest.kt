...
class OsmElementControllerTest {
    ...
    private lateinit var controller: OsmElementController
    ...
    @Before fun setUp() {
        ...
        controller = OsmElementController(elementDB, wayDB, nodeDB, geometryDB, geometryCreator)
    }
    ...
    @Test fun deleteAll() {
        ...
        val listener = mock<OsmElementSource.Listener>()
