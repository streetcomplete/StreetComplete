...
import de.westnordost.streetcomplete.data.osm.changes.delete.DeletePoiNodeUploader
...
class DeletePoiNodeUploaderTest {
    private val mapDataApi: MapDataApi = mock()
    private val uploader = DeletePoiNodeUploader(mapDataApi)
