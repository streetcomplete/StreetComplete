...
import de.westnordost.streetcomplete.data.osm.changes.split_way.SplitWayUploader
...
class SplitWayUploaderTest {
    private val mapDataApi: MapDataApi = mock()
    private val uploader = SplitWayUploader(mapDataApi)
