...
internal class UrlConfigKtTest {
    ...
    @Test fun `parse config without name`() {
        assertEquals(
            UrlConfig(null, listOf(q0, q2, q3), emptyList(), emptyList(), emptyList(), null),
    ...
    @Test fun `parse simple config`() {
        assertEquals(
            UrlConfig("Test", listOf(q0, q2, q3), emptyList(), emptyList(), emptyList(), null),
    ...
    @Test fun `parse config with overlays`() {
        assertEquals(
            UrlConfig("Test", emptyList(), emptyList(), emptyList(), listOf(o0, o1), null),
    ...
    @Test fun `parse config with selected overlay`() {
        assertEquals(
            UrlConfig("Test", listOf(q0, q2, q3), emptyList(), emptyList(), emptyList(), o1),
    ...
    @Test fun `url decode name`() {
        assertEquals(
            UrlConfig("Hello Wörld", emptyList(), emptyList(), emptyList(), emptyList(), null),
    ...
    @Test fun `parse config with quest sort orders`() {
        assertEquals(
            UrlConfig("Test", listOf(q0, q2, q3), listOf(q0 to q1, q3 to q0), emptyList(), emptyList(), null),
            parseConfigUrl("https://streetcomplete.app/s?n=Test&q=d&qo=0.1-3.0", quests, overlays)
        )
    }

    @Test fun `parse config with favorite quest types`() {
        assertEquals(
            UrlConfig("Test", listOf(q0, q2, q3), emptyList(), listOf(q0, q2), emptyList(), null),
            parseConfigUrl("https://streetcomplete.app/s?n=Test&q=d&fq=5", quests, overlays)
        )
    }

    @Test fun `parse ignores unknown ordinals`() {
        assertEquals(
            UrlConfig("Test", listOf(q0, q2, q3), listOf(q1 to q3), emptyList(), emptyList(), null),
    ...
    @Test fun `create url without name`() {
        assertEquals(
            ...
            createConfigUrl(UrlConfig(null, listOf(q0, q2, q3), emptyList(), emptyList(), emptyList(), null), quests, overlays),
        )
    }
    ...
    @Test fun `create simple url`() {
        assertEquals(
            ...
            createConfigUrl(UrlConfig("Test", listOf(q0, q2, q3), emptyList(), emptyList(), emptyList(), null), quests, overlays),
        )
    }
    ...
    @Test fun `create url with overlays`() {
        assertEquals(
            ...
            createConfigUrl(UrlConfig("Test", emptyList(), emptyList(), emptyList(), listOf(o0, o1), null), quests, overlays),
        )
    }
    ...
    @Test fun `create url with selected overlay`() {
        assertEquals(
            ...
            createConfigUrl(UrlConfig("Test", listOf(q0, q2, q3), emptyList(), emptyList(), emptyList(), o1), quests, overlays),
        )
    }
    ...
    @Test fun `create url with quest type orders`() {
        assertEquals(
            ...
            createConfigUrl(UrlConfig("Test", listOf(q0, q2, q3), listOf(q0 to q1, q3 to q2), emptyList(), emptyList(), null), quests, overlays),
        )
    }

    @Test fun `create url with favorite quest types`() {
        assertEquals(
            "https://streetcomplete.app/s?n=Test&q=d&fq=5",
            createConfigUrl(UrlConfig("Test", listOf(q0, q2, q3), emptyList(), listOf(q0, q2), emptyList(), null), quests, overlays)
        )
    }
    ...
    @Test fun `url encode name`() {
        assertEquals(
            ...
            createConfigUrl(UrlConfig("Hello Wörld", listOf(q0), emptyList(), emptyList(), emptyList(), null), quests, overlays)
        )
    }
    ...
    @Test fun `shorten name if too long`() {
        assertEquals(
            ...
            createConfigUrl(UrlConfig("123456789012345678901234567890123456789012345678901234567890X", listOf(q0), emptyList(), emptyList(), emptyList(), null), quests, overlays)
        )
    }
    ...
    @Test fun `create url ignores unknown quests`() {
        assertEquals(
            ...
            createConfigUrl(UrlConfig("Test", listOf(q0, qUnknown), listOf(q0 to qUnknown, q3 to q2), emptyList(), emptyList(), null), quests, overlays),
        )
    }
    ...
    @Test fun `create url ignores unknown overlays`() {
        assertEquals(
            ...
            createConfigUrl(UrlConfig("Test", emptyList(), emptyList(), emptyList(), listOf(o0, oUnknown), null), quests, overlays),
        )
    }
