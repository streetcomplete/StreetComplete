...
class AddRailwayCrossingBarrier : OsmElementQuestType<RailwayCrossingBarrier> {
    ...
    override val icon = Res.drawable.quest_railway
    ...
    @Composable
    override fun Form(on: (QuestAction<RailwayCrossingBarrier>) -> Unit, element: Element, geometry: ElementGeometry, countryInfo: CountryInfo) {
        AddRailwayCrossingBarrierForm(on, element, countryInfo)
    }
