...
mapOf(
    ...
    override val icon = Res.drawable.quest_opening_hours
    ...
    @Composable
    override fun Form(onAnswer: (OpeningHoursAnswer) -> Unit, element: Element, geometry: ElementGeometry, countryInfo: CountryInfo) {
