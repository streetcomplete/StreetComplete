...
class AddTracktype : OsmFilterQuestType<Tracktype>() {
    ...
    override val icon = Res.drawable.quest_tractor
    override val title = Res.string.quest_tracktype_title
    override val achievements = listOf(CAR, BICYCLIST)

    @Composable
    override fun Form(onAnswer: (QuestAnswer<Tracktype>) -> Unit, element: Element, geometry: ElementGeometry, countryInfo: CountryInfo) {
        ItemSelectQuestForm(
