...
class AddRecyclingContainerMaterials : OsmElementQuestType<RecyclingContainerMaterialsAnswer> {
    ...
    override val icon = Res.drawable.quest_recycling_container
    ...
    @Composable
    override fun Form(onAnswer: (QuestAnswer<RecyclingContainerMaterialsAnswer>) -> Unit, element: Element, geometry: ElementGeometry, countryInfo: CountryInfo) {
