...
class AddBikeParkingAccess : OsmFilterQuestType<ParkingAccess>() {
    ...
    override val icon = Res.drawable.quest_bicycle_parking_access
    override val title = Res.string.quest_bicycle_parking_access_title2
    override val achievements = listOf(BICYCLIST)

    @Composable
    override fun Form(onAnswer: (QuestAnswer<ParkingAccess>) -> Unit, element: Element, geometry: ElementGeometry, countryInfo: CountryInfo) {
        RadioGroupQuestForm(
