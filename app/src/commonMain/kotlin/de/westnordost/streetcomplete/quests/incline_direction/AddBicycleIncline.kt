...
class AddBicycleIncline : OsmElementQuestType<BicycleInclineAnswer> {
    ...
    override val icon = Res.drawable.quest_bicycle_incline
    ...
    @Composable
    override fun Form(on: (QuestAction<BicycleInclineAnswer>) -> Unit, element: Element, geometry: ElementGeometry, countryInfo: CountryInfo) {
        AddBicycleInclineForm(on, geometry)
    }
