...
class AddBikeParkingType : OsmFilterQuestType<BikeParkingType>() {
    ...
    override val icon = Res.drawable.quest_bicycle_parking
    ...
    @Composable
    override fun Form(onAnswer: (QuestAnswer<BikeParkingType>) -> Unit, element: Element, geometry: ElementGeometry, countryInfo: CountryInfo) {
        ItemSelectQuestForm(
