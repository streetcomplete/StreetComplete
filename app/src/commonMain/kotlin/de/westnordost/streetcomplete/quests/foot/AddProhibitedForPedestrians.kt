...
class AddProhibitedForPedestrians : OsmFilterQuestType<ProhibitedForPedestriansAnswer>() {
    ...
    override val icon = Res.drawable.quest_no_pedestrians
    ...
    @Composable
    override fun Form(onAnswer: (ProhibitedForPedestriansAnswer) -> Unit, element: Element, geometry: ElementGeometry, countryInfo: CountryInfo) {
        RadioGroupQuestForm(
