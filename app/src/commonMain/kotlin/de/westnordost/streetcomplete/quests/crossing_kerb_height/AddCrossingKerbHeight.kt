...
class AddCrossingKerbHeight : OsmElementQuestType<KerbHeight> {
    ...
    override val icon = Res.drawable.quest_wheelchair_crossing
    ...
    @Composable
    override fun Form(onAnswer: (QuestAnswer<KerbHeight>) -> Unit, element: Element, geometry: ElementGeometry, countryInfo: CountryInfo) {
        ItemSelectQuestForm(
