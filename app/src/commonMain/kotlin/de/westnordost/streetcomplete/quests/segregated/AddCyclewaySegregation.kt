...
class AddCyclewaySegregation : OsmFilterQuestType<CyclewaySegregation>() {
    ...
    override val icon = Res.drawable.quest_path_segregation
    override val title = Res.string.quest_segregated_title
    override val achievements = listOf(BICYCLIST, OUTDOORS)

    @Composable
    override fun Form(onAnswer: (QuestAnswer<CyclewaySegregation>) -> Unit, element: Element, geometry: ElementGeometry, countryInfo: CountryInfo) {
        AddCyclewaySegregationForm(onAnswer, countryInfo)
    }
