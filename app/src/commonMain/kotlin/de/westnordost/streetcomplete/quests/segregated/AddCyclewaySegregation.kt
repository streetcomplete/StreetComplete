...
class AddCyclewaySegregation : OsmFilterQuestType<CyclewaySegregation>() {
    ...
    @Composable
    override fun Form(on: (QuestAction<CyclewaySegregation>) -> Unit, element: Element, geometry: ElementGeometry, countryInfo: CountryInfo) {
        AddCyclewaySegregationForm(on, countryInfo)
    }
