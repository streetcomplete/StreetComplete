...
class AddDrinkingWaterType : OsmFilterQuestType<DrinkingWaterType>() {
    ...
    override val icon = Res.drawable.quest_drinking_water // another icon?
    override val title = Res.string.quest_drinking_water_type_title2
    override val achievements = listOf(CITIZEN, OUTDOORS)

    @Composable
    override fun Form(onAnswer: (QuestAnswer<DrinkingWaterType>) -> Unit, element: Element, geometry: ElementGeometry, countryInfo: CountryInfo) {
        ItemSelectQuestForm(
