...
fun WeekdayAndHolidayColumn(
    ...
    // TODO need to select between adding weekdays and adding off days!

    if (showDialog) {
        WeekdayAndHolidaySelectDialog(
            onDismissRequest = { showDialog = false },
            onSelected = { weekdaysSelectors, holidaysSelectors ->
                val newWeekdays = Weekdays(weekdaysSelectors, holidaysSelectors, Times(emptyList()))
