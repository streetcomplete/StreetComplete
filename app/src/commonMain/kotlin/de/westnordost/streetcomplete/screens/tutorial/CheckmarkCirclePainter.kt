...
fun checkmarkCirclePainter(progress: Float): VectorPainter = rememberVectorPainter(
    ...
    Path(
        pathData = rememberPath("m122,64a58,58 0,0 1,-58 58,58 58,0 0,1 -58,-58 58,58 0,0 1,58 -58,58 58,0 0,1 58,58z"),
        strokeLineWidth = 12f,
        stroke = SolidColor(Color.LeafGreen),
        trimPathEnd = (progress * 3f / 2).coerceIn(0f, 1f)
    )
    Path(
        pathData = rememberPath("m28.459,67.862c7.344,4.501 19.241,13.97 27.571,23.732 11.064,-20.587 27.756,-39.206 44.333,-55.458"),
        strokeLineWidth = 12f,
        stroke = SolidColor(Color.LeafGreen),
