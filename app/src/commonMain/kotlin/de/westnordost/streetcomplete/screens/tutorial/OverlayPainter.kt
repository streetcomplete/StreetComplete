...
fun overlayPainter(progress: Float): VectorPainter = rememberMapOverlayPainter {
    ...
    Group(
        clipPathData = rememberPath("M-111,111 l317,317 l317,-317 l-317,-317z"),
        ...
        Group(
            ...
            Path(
                pathData = rememberPath("m48.72,10.05 l-8.5,28.23 17.99,6.25 7.75,36.23 -20.99,22.24 8.99,10.49"),
            ...
            Path(
                pathData = rememberPath(animatedWayPath),
                strokeLineJoin = StrokeJoin.Round,
                strokeLineCap = StrokeCap.Round,
                strokeLineWidth = 8f,
            ...
            Path(
                pathData = rememberPath("M94.19,215.44 l2.5,-13.24 l12.49,-27.73 10.99,-7 27.48,15.74 20.49,-3.75 -0.25,-15.74 -10.24,-6 12.74,-26.23 5.75,-3.75 38.73,-9.99"),
                strokeLineJoin = StrokeJoin.Round,
                strokeLineCap = StrokeCap.Round,
                strokeLineWidth = 8f,
...
private val animatedWayPath = "m53.97,113.51 l-11.99,11.49 0.5,4.5 20.24,24.49 13.99,-6.75 20.49,18.49 -10.49,28.23 10.24,8.5"
