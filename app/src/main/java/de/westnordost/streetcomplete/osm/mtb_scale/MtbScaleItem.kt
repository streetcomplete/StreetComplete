...
private val MtbScale.titleResId: Int @StringRes get() = when (value) {
    0 -> R.string.overlay_mtbScale_0
    1 -> R.string.overlay_mtbScale_1
    2 -> R.string.overlay_mtbScale_2
    3 -> R.string.overlay_mtbScale_3
    4 -> R.string.overlay_mtbScale_4
    5 -> R.string.overlay_mtbScale_5
    6 -> R.string.overlay_mtbScale_6
    else -> 0
}

private val MtbScale.descriptionResId: Int @StringRes get() = when (value) {
    0 -> R.string.overlay_mtbScale_0_description
    1 -> R.string.overlay_mtbScale_1_description
    2 -> R.string.overlay_mtbScale_2_description
    3 -> R.string.overlay_mtbScale_3_description
    4 -> R.string.overlay_mtbScale_4_description
    5 -> R.string.overlay_mtbScale_5_description
    6 -> R.string.overlay_mtbScale_6_description
    else -> 0
}
