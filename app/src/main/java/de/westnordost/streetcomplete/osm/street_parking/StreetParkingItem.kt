...
// import de.westnordost.streetcomplete.osm.street_parking.ParkingPosition.SHOULDER // lets continue to not support this
...
private val ParkingPosition.titleResId: Int get() = when (this) {
    ...
    // SOULDER -> R.string.street_shoulder // lets continue to not support this
...
val DISPLAYED_PARKING_POSITIONS: List<ParkingPosition> = listOf(
    ...
    ON_KERB,
    STREET_SIDE,
    // SHOULDER // lets continue to not support this
    // PAINTED_AREA_ONLY // TODO remove
)
