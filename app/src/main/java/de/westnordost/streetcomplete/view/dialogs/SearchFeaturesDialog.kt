...
private val iconOnlyFeatures = mapOf(
    ...
    "leisure/picnic_table" to R.drawable.ic_pin_picnic_table,
    "amenity/waste_basket" to R.drawable.ic_pin_bin,
    "amenity/recycling_container" to R.drawable.ic_pin_recycling_container,
    "amenity/bicycle_repair_station" to R.drawable.ic_quest_bicycle_repair,
    "amenity/drinking_water" to R.drawable.ic_pin_water,
    "emergency/fire_hydrant" to R.drawable.ic_pin_fire_hydrant,
    ...
    "amenity/atm" to R.drawable.ic_pin_money,
    "natural/tree" to R.drawable.ic_quest_tree,
    "tourism/information/guidepost" to R.drawable.ic_quest_street_name,
    "amenity/post_box" to R.drawable.ic_pin_mail,
    "amenity/charging_station" to R.drawable.ic_pin_car_charger,
    "highway/street_lamp" to R.drawable.ic_preset_temaki_street_lamp_arm,
    "man_made/surveillance/camera" to R.drawable.ic_pin_surveillance_camera,
    ...
    "highway/crossing/traffic_signals" to R.drawable.ic_pin_pedestrian_traffic_light,
    ...
    "barrier/bollard" to R.drawable.ic_pin_bollard,
