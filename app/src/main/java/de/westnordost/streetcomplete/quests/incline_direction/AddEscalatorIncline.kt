...
class AddEscalatorIncline : OsmFilterQuestType<Incline>() {
    ...
    override val elementFilter = """
        ways with highway = steps
         ...
         and !incline
    """
    override val changesetComment = "Specify which way leads up for escalators"
    ...
    override fun getTitle(tags: Map<String, String>) = R.string.quest_escalator_incline_title
