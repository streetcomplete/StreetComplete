...
fun BuildingType.asItem(): Item<String> {
    return Item(this.osmTag, getIconResId(), getTitleResId(), getDescriptionResId(), this.subTypes?.toItems())
}

fun List<BuildingType>.toItems() = this.map { it.asItem() }

private fun BuildingType.getIconResId(): Int = when(this) {
...
private fun BuildingType.getTitleResId(): Int = when(this) {
...
private fun BuildingType.getDescriptionResId(): Int? = when(this) {
    HOUSE -> R.string.quest_buildingType_house_description
    APARTMENTS -> R.string.quest_buildingType_apartments_description
    DETACHED -> R.string.quest_buildingType_detached_description
    SEMI_DETACHED -> R.string.quest_buildingType_semi_detached_description
