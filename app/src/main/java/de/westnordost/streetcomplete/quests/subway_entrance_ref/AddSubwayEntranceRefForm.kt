...
class AddSubwayEntranceRefForm : AbstractOsmQuestForm<SubwayEntranceRefAnswer>() {

    override val contentLayoutResId = R.layout.quest_subway_entrance_ref
    ...
    override fun onClickOk() {
        applyAnswer(SubwayEntranceRef(ref!!))
    }
    ...
    private fun confirmNoRef() {
        ...
        AlertDialog.Builder(ctx)
            ...
            .setPositiveButton(R.string.quest_generic_confirmation_yes) { _, _ -> applyAnswer(NoVisibleSubwayEntranceRef) }
