 ...
 *
 * I is the type of each item in the image list (also a simple model object).
 * In MVC, this would be the view model.
 *
 * T is the type of the answer object (a simple model object) created by the quest form and
 * consumed by the quest type. In MVC, this would be the model.
 */
