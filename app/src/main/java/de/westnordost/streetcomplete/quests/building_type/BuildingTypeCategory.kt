...
enum class BuildingTypeCategory(val type: BuildingType?, val subTypes: List<BuildingType>) {
    ...
    COMMERCIAL(BuildingType.COMMERCIAL, listOf(
        OFFICE, RETAIL, KIOSK, INDUSTRIAL, WAREHOUSE, GUARDHOUSE, HOTEL, STORAGE_TANK, BRIDGE, DIGESTER
    )),
    ...
    OTHER(null, listOf(
        SHED, ROOF, BRIDGE, ALLOTMENT_HOUSE, SERVICE, TRANSFORMER_TOWER, HUT, TENT, TOILETS, HANGAR, BUNKER, HISTORIC, BOATHOUSE,
        ABANDONED, RUINS, RIDING_HALL, ABANDONED, RUINS
    )),
}
