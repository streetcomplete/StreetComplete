...
import de.westnordost.streetcomplete.quests.seating.Seating.TAKEAWAY_ONLY
...
class AddSeatingForm : AListQuestForm<Seating>() {
    override val items = listOf(
        ...
        TextItem(TAKEAWAY_ONLY, R.string.quest_seating_takeaway),
        TextItem(NO, R.string.quest_seating_no),
    )
}
