...
class AddBabyChangingTable constructor(o: OverpassMapDataDao) : SimpleOverpassQuestType(o) {
	...
	override fun getTitle(tags: Map<String, String>) =
		if (tags.containsKey("name")) R.string.quest_baby_changing_table_title
