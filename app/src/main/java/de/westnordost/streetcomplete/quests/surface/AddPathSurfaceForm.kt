...
class AddPathSurfaceForm : GroupedImageListQuestAnswerFragment() {
    ...
    override fun getAllItems() = arrayOf(
        ...
        Item("paved", R.drawable.panorama_path_surface_paved, R.string.quest_surface_value_paved,
            arrayOf(
        ...
        Item("unpaved", R.drawable.panorama_path_surface_unpaved, R.string.quest_surface_value_unpaved,
            arrayOf(
