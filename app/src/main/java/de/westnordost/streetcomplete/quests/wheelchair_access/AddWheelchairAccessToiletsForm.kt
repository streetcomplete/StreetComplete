...
class AddWheelchairAccessToiletsForm : AbstractOsmQuestForm<WheelchairAccessToiletsAnswer>() {
    ...
    override val buttonPanelAnswers = listOf(
        AnswerItem(R.string.quest_generic_hasFeature_no) { applyAnswer(WheelchairAccessToilets(NO.apply { updatedDescriptions = descriptions })) },
        AnswerItem(R.string.quest_generic_hasFeature_yes) { applyAnswer(WheelchairAccessToilets(YES.apply { updatedDescriptions = descriptions })) },
        AnswerItem(R.string.quest_wheelchairAccess_limited) { applyAnswer(WheelchairAccessToilets(LIMITED.apply { updatedDescriptions = descriptions })) },
    )
