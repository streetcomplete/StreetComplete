...
abstract class OpeningHoursForm<AnswerType> : AbstractQuestFormAnswerFragment<AnswerType>() {
    ...
    abstract fun showConfirm24_7Dialog()

    abstract fun showInputCommentDialog()

    abstract fun confirmNoSign()
