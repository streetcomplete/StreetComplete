...
public enum Cycleway
{
	...
	// a.k.a. protective lane, multipurpose lane or recommended lane
	SHARED_LANE        ( R.drawable.ic_cycleway_shared_lane, R.drawable.ic_cycleway_shared_lane_l, R.string.quest_cycleway_value_lane_soft),
