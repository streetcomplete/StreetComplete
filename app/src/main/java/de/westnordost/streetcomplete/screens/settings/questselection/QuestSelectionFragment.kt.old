...
class QuestSelectionFragment : TwoPaneDetailFragment(R.layout.fragment_quest_selection), HasTitle {
    ...
    override fun onAttach(context: Context) {
        ...
        questSelectionAdapter = QuestSelectionAdapter(requireContext(), viewModel, questTypeRegistry, prefs)
    ...
    private fun createOptionsMenu(toolbar: Toolbar) {
        ...
        if (prefs.getBoolean(Prefs.EXPERT_MODE, false))
            toolbar.menu.add(Menu.NONE, 3, 3, R.string.action_scee_quests)
