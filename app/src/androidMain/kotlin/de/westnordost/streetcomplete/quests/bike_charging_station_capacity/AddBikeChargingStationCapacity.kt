package de.westnordost.streetcomplete.quests.bike_charging_station_capacity
...
class AddBikeChargingStationCapacity : OsmFilterQuestType<Int>(), AndroidQuest {
    ...
    override val icon = R.drawable.ic_quest_car_charger_capacity // using the car charger icon because the logo also works for bikes
