...
class AddScooterChargingStationCapacity : OsmFilterQuestType<Int>(), AndroidQuest {
    ...
    override val elementFilter = """
        nodes, ways with
          ...
          and (
           !capacity:scooter
           or capacity:scooter older today -8 years
         )
    """
    ...
    override val achievements = listOf(CAR) // no scooter achievement
    ...
    override fun applyAnswerTo(answer: Int, tags: Tags, geometry: ElementGeometry, timestampEdited: Long) {
        tags.updateWithCheckDate("capacity:scooter", answer.toString())
    }
}
